...
<div class="field flex flex-col relative flex-[1] break-inside-avoid">
    ...
    <textarea id="{props.title}"on:change="{changeValue}" bind:value={value} bind:this="{inputEl}" name="{props.name}" class="min-h-[170px] py-4 px-3 rounded-xl shadow-[0_0_5px_-2px_#0e0e0ee6]"></textarea>
