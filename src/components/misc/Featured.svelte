...
<section class="sg">
    <div class="z-[2] md:shadow-[0_0_4px_-1px_hsla(var(--blackHsl),_0.6)] shadow-[0_0_3px_-1px_hsla(var(--blackHsl),_0.5)] grid py-8 pb-10 gap-[calc(var(--p-1)_*_1.5)_0] bg-white relative rounded-3xl md:px-10 px-5 overflow-y-hidden">
